...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //  if there is parse the date
        //  if not skip this code
        ...
        //  only do this if the activity is loading from Register.java
        //  the first time this loads we do not want to do this
        if(infoPassedToMe != null)
        {
            //  get information in the bundle called "Main" set in Register.java
